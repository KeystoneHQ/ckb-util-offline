...
impl ::core::fmt::Display for ExtraHashView {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
...
impl ::core::fmt::Display for UncleBlockView {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(
            f,
...
impl ::core::fmt::Display for BlockView {
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        write!(
            f,
...
impl ::core::iter::Iterator for UncleBlockVecViewIterator {
...
impl ::core::iter::ExactSizeIterator for UncleBlockVecViewIterator {
    fn len(&self) -> usize {
        self.2 - self.1
    }
}

impl ::core::iter::IntoIterator for UncleBlockVecView {
    type Item = UncleBlockView;
